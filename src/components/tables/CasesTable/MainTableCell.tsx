...
export const MainTableCell: React.FC<EditableCellProps> = ({
    ...
    if (dataIndex === "boxType") {
        inputNode = (
            ...
            hasFeedback
            name={dataIndex}
            style={{ margin: 0, width: "120px", padding: "30px 0 30px 0"}}
        ...
        inputNode = (
            ...
            rules={[{ required: true, message: "값을 입력하세요 (최대 5자리)", type: "number", max: 100000, min: 1 }]}
            >
                <InputNumber disabled style={{width: "120px"}} />
            </BaseButtonsForm.Item>
        )
    else {
        inputNode = (
